...
def load_page_config():
    ...
    # Add some padding to the top to avoid overlap
    ...
    # Add GitHub corner badge
    github_corner = """
    <div style="position: fixed; top: 3.75rem; right: 0; z-index: 999999;">
        <a href="https://github.com/Abdullah-MLE/football-EDA" target="_blank">
    ...
    st.markdown(github_corner, unsafe_allow_html=True)
